...
public interface IBrokers extends Serializable {
    ...
    /**
     * Load data from another generated Record/POJO implementing the common interface IBrokers
     */
    public void from(quantasma.app.db.tables.interfaces.IBrokers from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IBrokers
     */
    public <E extends quantasma.app.db.tables.interfaces.IBrokers> E into(E into);
}
